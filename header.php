                ...
                <ul class="nav navbar-right usernav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
                            ...
                            <span class="txt"><?=$_SESSION["user"]["data"]["nombre"]?></span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="menu">
                                <ul>
                                    <li><a href="#"><span class="icon16 icomoon-icon-user-plus"></span>Editar Cuenta</a></li>
                    ...
                    <li><a href="logout.php"><span class="icon16 icomoon-icon-exit"></span><span class="txt"> Cerrar Session</span></a></li>
                </ul>
            </div><!-- /.nav-collapse -->
        </nav><!-- /navbar --> 
